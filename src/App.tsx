...
export default function App() {
  const [products1, setProducts] = useState(null);
  useEffect(() => {
  ...
  <CartProvider>
    <UserProvider>
      <LikedProductsProvider>
            <Header /><div className="flex flex-col justify-between min-h-screen text-white pt-[90px]">
          <Header />
          <Routes>
            <Route path="/" element={<SearchFilter products1={products1} />} />
            <Route path="/home" element={<SearchFilter products1={products1} />} />
            <Route path="/wislist" element={<Wislist products1={products1} />}/>
