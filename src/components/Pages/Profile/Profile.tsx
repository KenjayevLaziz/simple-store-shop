            ...
            <div className="grid md:grid-cols-3 gap-8">
                <div className="rounded-lg border bg-transparent text-card-foreground shadow-sm md:col-span-1">
                    <div className="flex flex-col space-y-1.5 p-6">
                        ...
                        <div className="flex items-center p-6 pt-0">
                            <Button onClick={()=>{handleCheckout()}} className="text-white capitalize hover:bg-[#1E293B] inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border border-input bg-background cursor-pointer hover:text-accent-foreground h-10 px-4 py-2 w-full">
                                logout
                            </Button>
                        </div>
                    </div>
                ...
                <div className="md:col-span-2">
                    ...
                    <div className="rounded-lg border bg-transparent text-card-foreground shadow-sm py-5 px-2">
                        <div className="mb-7">
                            <h1 className="text-2xl font-semibold leading-none tracking-tight mb-2">Account Overview</h1>
                        ...
                        <div className="pt-0 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 rounded-lg border bg-transparent text-card-foreground shadow-sm">
                                    <h1 className="font-semibold tracking-tight text-lg">Wishlist</h1>
                                ...
                                <div className="rounded-lg border bg-transparent p-4 text-card-foreground shadow-sm">
                                    <h1 className="font-semibold tracking-tight text-lg">Cart</h1>
                                    <p className="text-3xl font-bold">{totalItems}</p>
                                    <p className="text-sm text-muted-foreground">Items in your cart</p>
                                </div>
